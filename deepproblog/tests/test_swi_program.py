...
from deepproblog.engines.approximate_engine.prolog_engine import PrologEngine
from deepproblog.engines.approximate_engine.prolog_engine.heuristics import PartialProbability
